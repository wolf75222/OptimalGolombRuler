...
int main(int argc, char* argv[])
{
    ...
    // Known optimal lengths (upper bounds)
    ...
    std::cout << "=============================================================\n";
    std::cout << "       OPTIMAL GOLOMB RULER - OPENMP V5 (n=" << n << ")\n";
    std::cout << "=============================================================\n";
    std::cout << "Algorithm: uint64_t ops + prefix-based + iterative\n";
    ...
    long long explored = getExploredCountV5();
