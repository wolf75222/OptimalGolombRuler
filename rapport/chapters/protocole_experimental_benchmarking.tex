...
\subsection{Configurations MPI}

\begin{table}[H]
\centering
\begin{tabular}{ccp{6cm}}
\toprule
\textbf{Processus MPI} & \textbf{Threads/proc} & \textbf{Configuration} \\
\midrule
1 & 8--96 & Référence OpenMP pure \\
2 & 4--48 & 2 nœuds, hypercube dim=1 \\
4 & 2--24 & 4 nœuds, hypercube dim=2 \\
8 & 1--12 & 8 tâches, hypercube dim=3 \\
16 & 1--6 & 16 tâches, hypercube dim=4 \\
32 & 1--3 & 32 tâches, hypercube dim=5 \\
\bottomrule
\end{tabular}
\caption{Configurations MPI testées}
